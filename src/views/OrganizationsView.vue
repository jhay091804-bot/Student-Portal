        ...
        >
          ...
          <div class="relative z-10">
            ...
            <div class="flex items-center gap-6 mt-auto">
              <div class="flex items-center gap-2">
                ...
                <span class="text-xs font-bold text-gray-700">{{ org.members_count }} Members</span>
              </div>
              <div class="flex items-center gap-2">
          ...
          <div class="mt-8 pt-8 border-t border-gray-50 flex items-center justify-between relative z-10">
            <div class="flex -space-x-3">
               ...
               <div class="w-8 h-8 rounded-full border-2 border-white bg-gray-900 flex items-center justify-center text-[10px] font-bold text-white">+{{ (org.members_count || 3) - 3 }}</div>
            </div>
            <button 
              v-if="!store.isAdmin"

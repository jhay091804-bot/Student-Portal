        ...
        <div class="p-6 border-b border-gray-50">
          <div class="flex items-center justify-between mb-6">
            ...
            <button 
              ...
              class="p-2 hover:bg-gray-50 rounded-xl transition-colors text-primary"
              :title="showContacts ? 'Show Recent' : 'New Message'"
            >
              <Users v-if="!showContacts" class="w-5 h-5" />
          ...
          <div class="relative group">
            ...
            <input 
              v-model="searchQuery"
              type="text" 
              :placeholder="showContacts ? 'Search students...' : 'Search messages...'"
        ...
        <div class="flex-1 overflow-y-auto custom-scrollbar">
          ...
          <template v-if="showContacts">
            <div 
              ...
              class="p-4 flex items-center gap-4 cursor-pointer hover:bg-gray-50 transition-all border-b border-gray-50/50"
            >
              <img :src="contact.avatar" class="w-12 h-12 rounded-2xl object-cover shadow-sm" />
              <div class="flex-1 min-w-0">
                <p class="font-bold text-gray-800 truncate">{{ contact.name }}</p>
                <p class="text-[10px] font-bold text-primary uppercase tracking-widest">{{ contact.program }} • {{ contact.year }}</p>
              </div>
            </div>
